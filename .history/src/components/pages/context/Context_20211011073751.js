...
const Context = ({ children }) => {
    const products = [
        ...
        },
        {
            ...
            ratings: faker.random.arrayElement([1, 2, 3, 4, 5]),
            texthang: 'Hãng: KAWASAKI',
            text: 'Kawasaki H2R sau một thời gian dài chinh phục ngôi vương trên đường đua mới đây đã chính thức được Kawasaki xác nhận sẽ sớm ngừng sản xuất. Những chiếc Kawasaki H2R chính hãng 2021 cuối cùng dự kiến sẽ được giao cho khách hàng đã đặt hàng trong năm nay.
